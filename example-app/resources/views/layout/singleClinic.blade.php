...
<section class="section department-single">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="department-img mb-5">
                    ...
                    @else
                    <img  class="img-fluid" src="{{asset('img/service/bg-1.jpg')}}" alt="#" style="width: 100%;"/>
                    @endif
                </div>
            </div>
        </div>
		...
		<section class="section service pb-5 pt-0">
    <div class="container">
        <div class="row ">
            <div class="col-lg-7 ">
		...
		@foreach($data3 as $y)
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="service-item mb-4">
					...
					@if($y->doctor_img)
                            <img src="{{ asset('/storage/img/'.$y->doctor_img) }}" width="180" alt="doctor-image"
                                class="img-fluid ">
                            @else
                            <img width="180" class="rounded-circle" src="{{asset('img/person-icon.png')}}" alt="#" />
                            @endif
							<div>
							<h5 class="mt-3"><a href="{{ url('doctor/id/'.$y->id) }}">{{$y->doctor_name}}</a></h5>
                    ...
                    <div class="content">
						<p>{{$y->cat_name}}</p></div>
					<a href="{{ url('doctor/id/'.$y->id) }}" class="read-more">Learn More <i
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="department-content mt-5">
                    ...
                    <form>
                        <a href="{{url('appClinic/id/'.$data->id)}}" class="btn btn-main-2 btn-round-full mt-3">Make an
